...
class ViewTransformer():
    def __init__(self):
        ...
        self.perspective_tranformer = cv2.getPerspectiveTransform(self.pixel_verticies,self.target_verticies)
    ...
    def transform_point(self,point):
        ...
        transform_point = cv2.perspectiveTransform(reshaped_point,self.perspective_tranformer)
